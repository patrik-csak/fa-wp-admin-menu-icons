 ...
 *
 * You should have received a copy of the GNU General Public License along with Font Awesome Admin
 * Menu Icons. If not, see https://www.gnu.org/licenses/gpl.html.
 */
